function eclipse() {
  var id = document.getElementById("eclipse");
  var context = id.getContext("2d");
  context.strokeStyle =  "#040ab3";
  context.lineWidth = 10;
  context.beginPath();
  context.ellipse(150, 150, 150, 100, 45 * Math.PI/180, 0, 2 * Math.PI);
  context.stroke();
}
