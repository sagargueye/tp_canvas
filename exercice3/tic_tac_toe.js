...
document.onkeydown= function (event) {
  event = event || window.event;
  event.preventDefault();
  if (event.keyCode == 49) {//touche: 1
    ajouterWithKeyboard(0,0);
  } else if (event.keyCode == 50) {//touche: 2
    ajouterWithKeyboard(1,0);
  } else if (event.keyCode == 51) {//touche: 3
    ajouterWithKeyboard(2,0);
  } else if (event.keyCode == 52) {//touche: 4
    ajouterWithKeyboard(0,1);
  } else if (event.keyCode == 53) {//touche: 5
    ajouterWithKeyboard(1,1);
  } else if (event.keyCode == 54) {//touche: 6
    ajouterWithKeyboard(2,1);
  } else if (event.keyCode == 55) {//touche: 7
    ajouterWithKeyboard(0,2);
  } else if (event.keyCode == 56) {//touche: 8
    ajouterWithKeyboard(1,2);
  } else if (event.keyCode == 57) {//touche: 9
    ajouterWithKeyboard(2,2);
  }
};
...
/*Ajouter un pion avec les touches du clavier*/
function ajouterWithKeyboard(indexX,indexY){
  if(fini) {
    return;
  }
  if (indexX != -1 && indexY != -1) {
